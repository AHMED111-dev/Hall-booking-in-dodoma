...
<?php require('inc/user_header.php'); ?>
  ...
  <div class="my-5 px-4">
    <h2 class="fw-bold h-font text-center">JK CONVENTION CENTRE</h2>
    <div class="h-line bg-dark"></div>
    <p class="text-center fw-bold mt-3">
        The JK Convention Centre is a convention centre
        in the Tanzanian capital of Dodoma
        <br>
        It was inaugurated by President Jakaya Kikwete on 9 July 2015.
    </p>
  </div>
    ...
    <div class="row justify-content-between align-items-center">
      <div class="card-hover col-lg-6 col-md-6 mb-5 px-4">
            <div class="bg-white rounded shadow p-4">
              <iframe class="w=100 rounded mb=4" height="320px" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.57731315208!2d35.75896507377955!3d-6.187277360618852!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x184de54a9cf1697b%3A0xde2e0252de5daa8b!2sJAKAYA%20KIKWETE%20CONVENTION%20CENTRE!5e0!3m2!1sen!2stz!4v1751350978904!5m2!1sen!2stz"></iframe>
              <h5>Address</h5>
              <a href="https://maps.app.goo.gl/k93Jt6rniSBMNeof9" target="_blank" class="d-inline-block text-decoration-none text-dark mb-2">
                <i class="bi bi-geo-alt-fill"></i>JK CONVENTION CENTRE.
              </a>
    ...
    <div class="row">
      <div class="card-hover col-lg-3 col-mb-6 mb-4 px-4">
        <div class="bg-white rounded shadow p-4 border-top border-4 text-center box">
          ...
          <h4 class"mt-3">3+ HALLS</h4>
        </div>
      </div>
      <div class="card-hover col-lg-3 col-mb-6 mb-4 px-4">
        <div class="bg-white rounded shadow p-4 border-top border-4 text-center box">
          <i class="bi bi-people fs-2 me-8 text-primary"></i>
          <h4 class"mt-3">1500+ CAPACITY</h4>
        </div>
      </div>
      <div class="card-hover col-lg-3 col-mb-6 mb-4 px-4">
        <div class="bg-white rounded shadow p-4 border-top border-4 text-center box">
